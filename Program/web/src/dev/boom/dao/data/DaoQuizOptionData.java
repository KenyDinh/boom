...
import dev.boom.tbl.data.TblQuizOptionData;

public class DaoQuizOptionData extends FixData implements IDaoFactory {
	...
	protected List<Field> getField() {
		TblQuizOptionData data = new TblQuizOptionData();
