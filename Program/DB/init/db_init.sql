...
CREATE TABLE `demo_session_info` (
  ...
  `demo_location` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `demo_signup_info` (
  `id` SMALLINT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `game_name` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `speaker_name` VARCHAR(32) COLLATE utf8mb4_unicode_ci NOT NULL,
