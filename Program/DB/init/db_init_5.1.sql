...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`boom` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
CREATE TABLE `device_info` (
  ...
  `image` varchar(18) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `device_register_info` (
  ...
  `device_name` varchar(125) COLLATE utf8_unicode_ci NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  `username` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `quiz_log_info` (
  ...
  `user_id` int(10) unsigned NOT NULL,
  `username` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `correct_answer` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `player_answer` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
